...
describe SudokuBoard do
  ...
  describe '#valid_guess?' do
    it 'returns true if guess is valid' do
      board = [
        [5, 3, 0, 0, 7, 0, 0, 0, 0],
        [6, 0, 0, 1, 9, 5, 0, 0, 0],
        [0, 9, 8, 0, 0, 0, 0, 6, 0],
      ...
      sudoku = SudokuBoard.new(board)
      expect(sudoku.valid_guess?(0, 2, 4)).to eq(true)
    end

    it 'returns false if guess is invalid' do
      board = [
        [5, 3, 0, 0, 7, 0, 0, 0, 0],
        [6, 0, 0, 1, 9, 5, 0, 0, 0],
        [0, 9, 8, 0, 0, 0, 0, 6, 0],
      ...
      sudoku = SudokuBoard.new(board)
      expect(sudoku.valid_guess?(0, 2, 5)).to eq(false)
    end
  end

  describe '#empty_cell?' do
    it 'returns true if the cell is empty (zero value)' do
      board = [
        [5, 3, 0, 0, 7, 0, 0, 0, 0],
        [6, 0, 0, 1, 9, 5, 0, 0, 0],
        [0, 9, 8, 0, 0, 0, 0, 6, 0],
      ...
      sudoku = SudokuBoard.new(board)
      expect(sudoku.empty_cell?(0, 2)).to eq(true)
    end

    it 'returns false if the cell is not empty (non-zero value)' do
      board = [
        [5, 3, 0, 0, 7, 0, 0, 0, 0],
        [6, 0, 0, 1, 9, 5, 0, 0, 0],
        [0, 9, 8, 0, 0, 0, 0, 6, 0],
      ...
      sudoku = SudokuBoard.new(board)
      expect(sudoku.empty_cell?(0, 0)).to eq(false)
    end
  end
end
